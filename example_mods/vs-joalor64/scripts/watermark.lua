...
function onCreate()
    makeLuaText('songText', songName .. " " .. currentDifficulty .. " - VS Joalor64 V1.0.0-DEMO", 0, 2, 701);
...
function onUpdate(elapsed)
    ...
    setTextString('songText', songName .. " " .. currentDifficulty .. " - VS Joalor64 V1.0.0-DEMO");
end